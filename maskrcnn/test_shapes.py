...
#'''
#基础设置
dataset_root_path="/home/cris/works/yjx/maskRCNN/"
img_floder = dataset_root_path+"rgb"
mask_floder = dataset_root_path+"mask"
#yaml_floder = dataset_root_path
imglist = os.listdir(img_floder)
...
# 获取保存的权重，或者手动指定目录位置
model_path = os.path.join(ROOT_DIR, "logs/shapes20180812T1631/mask_rcnn_shapes_0002.h5")
...
root_dir = '/home/cris/works/yjx/maskRCNN/resize/board9/'
output_dir = '/home/cris/works/yjx/maskRCNN/resize/testoutput/'
