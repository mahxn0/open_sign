...
#设置预置位
class PTZ_Control(object):
    def __init__(self):
        pass
    def set_preset(self,ser, cmd_setpreset):
        ...
        try:
            ...
            print "Error!"
    #转到预置点
    def goto_preset(self,ser, cmd_gotopreset):
    ...
    #查询水平坐标
    def get_panpos(self,ser, cmd_getpanpos):
    ...
    #查询垂直坐标
    def get_tiltpos(self, cmd_gettiltpos):
    ...
    #查询像机ZOOM坐标
    def get_zoompos(self, cmd_getzoompos):
    ...
    #设置水平坐标
    def set_panpos(self,ser, cmd_setpanpos):
    ...
    #设置水平向左
    def set_panleft(self,cameracontrol_id, current_ser, current_val_panpos, step_value):
    ...
    #设置水平向右
    def set_panright(self,cameracontrol_id, current_ser, current_val_panpos, step_value):
        set_val_panpos = current_val_panpos - step_value
        if set_val_panpos < 0:
            set_val_panpos += 35999
        cmd_setpanpos[1] = cameracontrol_id
    ...
    #设置垂直坐标
    def set_tiltpos(self,ser, cmd_settiltpos):
    ...
    #设置垂直向上
    def set_tiltup(self,cameracontrol_id, current_ser, current_val_tiltpos, step_value):
    ...
    #设置垂直向下
    def set_tiltdown(self,cameracontrol_id, current_ser, current_val_tiltpos, step_value):
        set_val_tiltpos = current_val_tiltpos - step_value
        print('set_val_tiltpos',set_val_tiltpos)
    ...
    #设置像机ZOOM坐标
    def set_zoompos(self,ser, cmd_setzoompos):
    ...
    #设置放大
    def set_zoominc(self,cameracontrol_id, current_ser, current_val_zoom, step_value):
    ...
    #设置缩小
    def set_zoomdec(self,cameracontrol_id, current_ser, current_val_zoom, step_value):
        set_val_zoompos = current_val_zoom - step_value
    ...
    def get_sumcs(self,cmdin):
        result = (cmdin[1] + cmdin[2] + cmdin[3] + cmdin[4] + cmdin[5]) % 256;
        return result

    def init_usbdev(self,dev, baudrate):
        try:
    ...
    def init_camera(self,dev, ipaddress):
    ...
    def get_planeimage(self,str_planeinfo, ser_dev,ipstream_dev):
        param_planeinfo = []
    ...
    def get_singleimage(self,str_planeinfo, ser_dev,ipstream_dev, data, single_image,singleid):
        ...
        #返回放大倍数
            ...
            #frame_stream_list.append(frame_stream)
                ...
                print('Total Permission Files: ', filenum)
            #返回预置点
                goto_preset(ser_dev, cmd_gotopreset)
                time.sleep(5)
        #return locate ptz state
        return frame_stream,finalx_set,finaly_set,lagerfacter,filenum


    def get_deviceimage(self,str_planeinfo, ser_dev,ipstream_dev, data, single_image,singleid,prex_set,prey_set,lagerfacter):
        ...
        frame_width = data.end_x[i] - data.begin_x[i];
            ...
            goto_preset(ser_dev, cmd_gotopreset)
                time.sleep(5)
        #return locate ptz state
        return frame_stream,filenum


    def hmset(self,current_dev,str_planeinfo):
    ...
    def control_camera_id(self,cameracontrol_id, current_ser, cameracontrol_type, cameracontrol_step, \
    ...
    def control_camera(self,str_controlinfo):
        #控制相机 相机号/动作方向/动作步长 
    ...
    def control_camerareset(self,camera_id_reset):
