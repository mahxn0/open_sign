...
import controlmodulecp_final as ct
...
if __name__=='__main__':
   ...
   #     print('已创建Record文件夹')
   # if os.path.exists(MulboardPath):
   #     shutil.rmtree(MulboardPath)
   #     print('多面文件夹已经清空')
   # else:
   # 	os.makedirs(MulboardPath)
   #     print('已创建多面文件夹')
   # if os.path.exists(SinboardPath):
   #     shutil.rmtree(SinboardPath)
   #     print('单面文件夹已经清空')
   # else:
   #     os.makedirs(SinboardPath)
   #     print('已创建单面文件夹')
   # if os.path.exists(DevicePath):
   #     shutil.rmtree(DevicePath)
   #     print('设备文件夹已经清空')
   # else:
   ...
   # #初始化相机
    del_file(RecordPath)
    del_file(MulboardPath)
    del_file(SinboardPath)
    del_file(DevicePath)
